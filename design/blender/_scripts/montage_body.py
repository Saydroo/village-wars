# -*- coding: utf-8 -*-
"""Koerper-Grundform: Front+Seite in EIN Pruefbild. VERSIONIERT (nie ueberschreiben):
schreibt KOERPER_grundform_check_vNN.png direkt nach units/archer, NN = max+1.
Start bei v03 (v01=kastiger Rumpf, v02=Ei-Rumpf existierten unversioniert)."""
import os, re, sys
...
a = flat(os.path.join(FT, "koerper_neu_front.png"))
b = flat(os.path.join(FT, "koerper_neu_side.png"))
...
d.text((pad + a.width // 2, 8), "Front", anchor="ma", font=font(28), fill=(20, 20, 20))
d.text((a.width + 2 * pad + b.width // 2, 8), "Seite", anchor="ma", font=font(28), fill=(20, 20, 20))

vmax = 2   # v01/v02 waren die unversionierten Vorstufen
