# -*- coding: utf-8 -*-
"""Figur-Montage: Front+Seite in EIN Pruefbild, VERSIONIERT (nie ueberschreiben)."""
import os, re, sys
...
a = flat(os.path.join(FT, "figur_front.png"))
b = flat(os.path.join(FT, "figur_side.png"))
